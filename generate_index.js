  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    body::before {
      ...
      background-image: linear-gradient(to bottom, rgba(8, 7, 6, 0.75), rgba(8, 7, 6, 0.98)), url('https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?q=80&w=2070&auto=format&fit=crop');
  ...
  <div id="admin-dashboard" class="admin-dashboard" style="display:none;">
      <div class="modal-header" style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:20px; border-bottom:1px solid var(--border); padding-bottom:20px; margin-bottom:30px;">
        ...
        <div class="tab-bar" style="flex:1; justify-content:flex-start; margin-bottom:0; gap:8px;">
          ...
          <button class="tab-btn" onclick="switchTab('limits')">⏳ Bekleme Süresi</button>
          ...
          <button class="tab-btn" id="settings-tab-btn" onclick="switchTab('settings')" style="display:none;">⚙️ Sistem Araçları</button>
        </div>
          ...
          <div style="display:flex; flex-direction:column; gap:14px; margin-top:10px;">
            ...
            <div style="margin-top:20px; padding-top:20px; border-top:1px solid rgba(255,255,255,0.05);">
              <div class="panel-input-row">
                ...
                <button class="panel-btn" onclick="syncDrive()">🔄 Eski Parçaları Çek</button>
              </div>
    ...
    try {
      ...
      if (currentInboxList.length === 0) ib.innerHTML = '<tr><td colspan="4" class="empty-state">Yeni parça yok.</td></tr>';
        ...
        currentInboxList.forEach(function(s, idx) {
          ...
          let trackInfo = '<td><div style="font-weight: 700; font-size: 1rem; color: #fff; margin-bottom: 4px;">' + esc(s.trackName) + '</div><div style="font-size: 0.8rem; color: var(--txt2);">' + esc(s.fullName) + ' &nbsp;•&nbsp; <span style="color:var(--gold);">' + esc(s.aiTool) + '</span></div></td>';
